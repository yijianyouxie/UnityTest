...
#include "CGIncludes/UnityGlobalIllumination.cginc"
...
#if !defined (TLSTUDIO_BRDF_PBS) // allow to explicitly override BRDF in custom shader
#if TLSTUDIO_BRDF_HIGH == 2
#define TLSTUDIO_BRDF_PBS BRDF1_Unity_PBS
#else  
#define TLSTUDIO_BRDF_PBS BRDF2_Unity_PBS
#endif
#endif
//-------------------------------------------------------------------------------------
