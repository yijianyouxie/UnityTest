...
VertexOutputForwardBase vertForwardBase (VertexInput v)
{
	...
	o.tex = TexCoords(v);
	float3 dis = posWorld.xyz - _WorldSpaceCameraPos;
	o.eyeVec = NormalizePerVertexNormal(dis);

	UNITY_TRANSFER_CY_FOG(o, dis.xyz, posWorld.y);
...
half4 fragForwardBaseInternal (VertexOutputForwardBase i)
{
	...
	UNITY_APPLY_CY_FOG(i.cyFogCoord, c);
...
half4 fragForwardAddInternal (VertexOutputForwardAdd i)
{
	...
	UNITY_APPLY_CY_FOG_ADDPASS(i.cyFogCoord, c);
