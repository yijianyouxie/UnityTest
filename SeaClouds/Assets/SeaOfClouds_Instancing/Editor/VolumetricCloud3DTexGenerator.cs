...
namespace Mongoose
{
    ...
    public class VolumetricCloud3DTexGenerator 
    {
        ...
        private static void Generate3DNoiseTex()
        {
            ...
            string t_Path = "Assets/SeaOfClouds_Instancing/Noises/";
            for (int index = 0; index < 16; index++)
            {
                ...
                {
                    Debug.LogError("========================t_FullPath:" + t_FullPath);
                }
            }
            ...
            AssetDatabase.CreateAsset(t_DensityTex, "Assets/SeaOfClouds_Instancing/Noise3D.asset");
