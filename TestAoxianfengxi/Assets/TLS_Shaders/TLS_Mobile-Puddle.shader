...
void surf (Input IN, inout SurfaceOutput o) {
	fixed4 c = tex2D(_SkyTex, IN.uv_MainTex);
...
fixed4 frag_surf (v2f_surf IN) : SV_Target {
  ...
  fixed4 puddle = tex2D(_MainTex, surfIN.uv_MainTex);

  c += CustomLightingBlinnPhongPuddle (o, worldPos, gi, horizon);
  ...
  c.a = (1.0 - puddle.r) * _Color.a * _WeatherEffectControl.g;
  return c;
}
