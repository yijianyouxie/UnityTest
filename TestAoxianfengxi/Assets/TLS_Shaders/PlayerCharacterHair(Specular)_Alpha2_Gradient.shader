Shader "TLStudio/Character/PlayerCharacterHair(Specular)_Alpha2_Gradient" {
	Properties{
			...
			float4 frag (v2f i) : SV_Target
			{
				...
				if (HairFreeColor > 0)
				{
					...
					ambient = tiaoranSwitch * (area1Value * tAreaColor1.rgb + area2Value * tAreaColor2.rgb
						+ area3Value * tAreaColor3.rgb + area4Value * tAreaColor4.rgb) * i.SHLighting * _AmbientColor
