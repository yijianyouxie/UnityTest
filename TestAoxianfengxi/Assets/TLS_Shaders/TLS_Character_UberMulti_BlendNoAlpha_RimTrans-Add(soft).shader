...
Shader "TLStudio/Character/UberMulti_BlendNoAlpha_RimTrans-Add(soft)" {
    Properties {
    ...
    SubShader {
        ...
        Pass {
			...
			ColorMask RGBA
			Cull[_Cull]  Lighting Off ZWrite Off Fog{ Color(0,0,0,0) }
			Stencil
			{
...
/// Glitter MatCap:
				...
				return fixed4(finalColor*finalA, finalA);
