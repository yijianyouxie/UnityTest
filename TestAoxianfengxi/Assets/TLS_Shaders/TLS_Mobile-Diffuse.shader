		...
		Pass {
			...
			fixed4 frag_surf (v2f_surf IN) : SV_Target {
				...
				if (EnableGlobalSpecular > 0)
				{
					...
					float3 finalGlobalSpecular = /*o.Alpha * */globalSpecular * GlobalSpecularIntensity * FresnelTerm(GlobalSpecularColor.xyz, lhCustom) * pow((1 - nv), 1);
					c.rgb = c.rgb + finalGlobalSpecular * 0.45f * SpecularIntensity * o.Specular;
