...
Shader "TLStudio/Transparent/Alpha2" {
Properties {
	_Color("Color", Color) = (1,1,1,1)
	_MainTex ("Base (RGB)", 2D) = "white" {}
	_MinDot("MinDot",Range(0,1)) = 0
...
CGPROGRAM
#pragma skip_variants FOG_EXP DIRLIGHTMAP_COMBINED DYNAMICLIGHTMAP_ON LIGHTMAP_SHADOW_MIXING VERTEXLIGHT_ON
// compile directives
...
{
    fixed diff = max (_MinDot, dot (s.Normal, lightDir));
