Shader "TLStudio/CharCrystal" 
{
	Properties
	{
		...
		_CharLightDir("_CharLightDir", vector) = (1,1,1,1)
		_CharMainLightSpecularDirection("_CharMainLightSpecularDirection", vector) = (1,1,1,1)
		_CharLightColor("_CharLightColor", Color) = (1,1,1,1)
	...
	SubShader
	{
		...
		Pass
		{
			...
			#pragma multi_compile _ _UICHAR0
			...
			half4 frag(v2f i, half facing : VFACE) : COLOR
			{
				...
				float3 lightSpecularDirection = normalize(_WorldSpaceLightPos0.xyz);				
				half3 lightColor = _LightColor0.xyz * attenuation;
#endif
	...
	FallBack "TLStudio/CharCrystal_Low"
