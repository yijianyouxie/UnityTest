...
Shader "TLStudio/FX/ICE_WEATHER" {
    Properties {
...
//        _Color2 ("Color2", Color) = (0.5,0.5,0.5,1)
    ...
    SubShader {
        ...
        Pass {
            ...
            CGPROGRAM
            #pragma skip_variants FOG_EXP DIRLIGHTMAP_COMBINED DYNAMICLIGHTMAP_ON LIGHTMAP_SHADOW_MIXING VERTEXLIGHT_ON INSTANCING_ON SHADOWS_CUBE SHADOWS_DEPTH DIRECTIONAL_COOKIE POINT POINT_COOKIE SPOT UNITY_HDR_ON
            #pragma vertex vert
...
/////// Diffuse:
				...
				fixed3 diffuse = (directDiffuse + indirectDiffuse) * (lerp(_FXICE_Color2.rgb,_FXICE_Color1.rgb,_MainTexture_var.r));
////// Emissive:
