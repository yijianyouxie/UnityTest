...
SubShader {
	Tags {"Queue"="AlphaTest+150" "IgnoreProjector"="True" "RenderType"="Geometry" "ShadowProjector" = "true"}
	LOD 150
    Cull Off
...
fixed4 frag_surf (v2f_surf IN) : SV_Target {
  ...
  #ifdef LIGHTMAP_OFF
  c = LightingHairSpecular (o, _WorldSpaceLightPos0.xyz, normalize(fixed3(IN.viewDir)), atten);
