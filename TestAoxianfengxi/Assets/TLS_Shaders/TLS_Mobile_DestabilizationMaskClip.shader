...
Shader "TLStudio/Effect/DestabilizationMaskClip" {
    Properties {
    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                o.worldPos = mul(unity_ObjectToWorld, v.vertex).xy * _ClipRange0.zw + _ClipRange0.xy;
                return o;
            }
            fixed4 frag(VertexOutput i) : COLOR {
                ...
                _MainTexture_var.a *= clamp( min(factor.x, factor.y), 0.0, 1.0);
