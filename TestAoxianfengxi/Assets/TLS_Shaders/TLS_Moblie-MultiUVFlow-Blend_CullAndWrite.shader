...
Shader "TLStudio/Effect/MultiUVFlow-Blend_CullAndWrite"
{
	Properties{
		[Header(Tips begain)]
	...
	SubShader{
		...
		Pass{
			...
			CGPROGRAM
			#pragma skip_variants FOG_EXP INSTANCING_ON DIRECTIONAL DIRLIGHTMAP_COMBINED DYNAMICLIGHTMAP_ON LIGHTMAP_SHADOW_MIXING LIGHTPROBE_SH SHADOWS_SCREEN SHADOWS_SHADOWMASK VERTEXLIGHT_ON SHADOWS_CUBE SHADOWS_DEPTH DIRECTIONAL_COOKIE POINT POINT_COOKIE SPOT UNITY_HDR_ON
			#pragma vertex vert
