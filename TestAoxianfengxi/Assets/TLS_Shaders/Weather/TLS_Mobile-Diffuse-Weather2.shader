...
Shader "TLStudio/Weather/Opaque/TLS_Mobile-Diffuse-Weather2"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            CGPROGRAM
            #pragma skip_variants DIRLIGHTMAP_COMBINED DYNAMICLIGHTMAP_ON LIGHTMAP_SHADOW_MIXING LIGHTPROBE_SH VERTEXLIGHT_ON
		...
		fixed _NormalNoiseTiling;
                ...
                {
                    float2 offset = tex2D(_NormalNoiseMap, IN.uv_MainTex+frac(_NormalNoiseTiling+_NormalNoiseSpeed * _Time.x)).xy;
                    fixed4 c = tex2D(_MainTex, frac(IN.uv_MainTex+offset.xy*0.02));
