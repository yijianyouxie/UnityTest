...
Shader "TLStudio/Weather/Transparent/Cutout-Weather" {
	Properties {
...
CGPROGRAM
#pragma skip_variants DIRLIGHTMAP_COMBINED DYNAMICLIGHTMAP_ON LIGHTMAP_SHADOW_MIXING LIGHTPROBE_SH SHADOWS_SCREEN VERTEXLIGHT_ON SHADOWS_CUBE SHADOWS_DEPTH
// compile directives
...
fixed4 frag_surf (v2f_surf IN) : SV_Target {
  ...
  gi.light.color = _LightColor0.rgb * 2;
  gi.light.dir = lightDir * 2;
...
#LINE 67
	...
	FallBack "TLStudio/Transparent/Cutout"
}
