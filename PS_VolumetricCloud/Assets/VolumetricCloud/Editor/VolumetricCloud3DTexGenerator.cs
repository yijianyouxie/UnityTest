...
namespace Mongoose
{
    ...
    public class OperateWindow:EditorWindow
    {
        ...
        static string width = "256";
        static string height = "256";
        static string count = "16";
        ...
        private void Split3DTexture()
        {
            ...
            Color[] allColors = t_tex.GetPixels();
            ...
            {
                Color[] part = new Color[_width * _height];
                Array.Copy(allColors, i * _width * _height, part, 0, _width * _height);

                Texture2D Tex2d = new Texture2D(_width, _height);
                Tex2d.SetPixels(part);
                Tex2d.Apply();
        ...
        [MenuItem("TLStudio/VolumetricCloud/Generate3DNoiseTex", priority = 11)]
        private static void Generate3DNoiseTex()
        {
            ...
            string t_Path = AssetDatabase.GetAssetPath(Selection.activeObject) + "/";// "Assets/GameMain/Temp/Output3DTex/Base";
            Debug.LogError("============Selection.activeObject:" + Selection.activeObject + " path:" + t_Path);
            ...
            AssetDatabase.CreateAsset(t_DensityTex, "Assets/" + Selection.activeObject.name + ".asset");
            AssetDatabase.Refresh();
